...
import com.kvmix.dashboard.repository.UserRepository;
import com.kvmix.dashboard.security.AuthoritiesConstants;
import com.kvmix.dashboard.service.UserService;
import com.kvmix.dashboard.service.dto.AdminUserDTO;
import com.kvmix.dashboard.service.mapper.UserMapper;
...
class UserResourceIT {
  ...
  private static final String UPDATED_LOGIN = "kvmix";
  ...
  void updateUserExistingLogin() throws Exception {
    ...
    AdminUserDTO userDTO = new AdminUserDTO();
    userDTO.setId(updatedUser.getId());
    userDTO.setLogin("kvmix"); // this login should already be used by anotherUser
    userDTO.setFirstName(updatedUser.getFirstName());
    userDTO.setLastName(updatedUser.getLastName());
