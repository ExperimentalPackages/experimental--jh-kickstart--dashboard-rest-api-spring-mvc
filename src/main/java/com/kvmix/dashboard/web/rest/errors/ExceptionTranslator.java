package com.kvmix.dashboard.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
  ...
  private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
    if (
        ex instanceof com.kvmix.dashboard.service.UsernameAlreadyUsedException
    ) {
      return (ProblemDetailWithCause) new LoginAlreadyUsedException().getBody();
    }
    if (
        ex instanceof com.kvmix.dashboard.service.EmailAlreadyUsedException
    ) {
      return (ProblemDetailWithCause) new EmailAlreadyUsedException().getBody();
    }
    if (
        ex instanceof com.kvmix.dashboard.service.InvalidPasswordException
    ) {
  ...
  private boolean containsPackageName(String message) {
    ...
    return StringUtils.containsAny(message, "org.", "java.", "net.", "jakarta.", "javax.", "com.", "io.", "de.", "com.kvmix.dashboard");
  }
}
